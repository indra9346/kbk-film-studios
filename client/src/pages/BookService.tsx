  ...
  const handleSubmitBooking = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await api.submitBooking({
        ...
        quotedAmount: selectedService?.basePrice,
        priceSnapshot: selectedService ? {
          serviceId: selectedService.id,
          serviceTitle: selectedService.title,
          ...
          priceLabel: selectedService.priceLabel,
          inclusions: [...selectedService.inclusions],
          exclusions: [...selectedService.exclusions],
          turnaroundDays: selectedService.turnaroundDays,
