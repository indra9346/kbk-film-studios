      ...
      <div className="relative w-full max-w-4xl max-h-[94vh] flex flex-col bg-surface-200 border border-gold/40 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 border-b border-surface-50 bg-surface-100/95 z-20">
          <div className="flex items-center gap-2 sm:gap-3 overflow-hidden">
            <span className="px-2.5 py-0.5 rounded-md bg-gold/15 text-gold text-[10px] sm:text-xs font-bold uppercase tracking-wider border border-gold/30 shrink-0 flex items-center gap-1">
              {isPic ? <ImageIcon className="w-3 h-3" /> : <Film className="w-3 h-3" />}
              {work.category}
            </span>
          ...
          <div className="flex items-center gap-2 shrink-0">
            {isPic ? (
              <div className="flex items-center gap-1 bg-surface-200 px-2 py-1 rounded-xl border border-gold/20">
                <button
                  type="button"
