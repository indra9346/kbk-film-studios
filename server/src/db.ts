...
const INITIAL_PUBLIC_WORKS: PublicWork[] = [
  {
    id: 'work-muhurtham',
    title: 'Grand Traditional Muhurtham Master Film',
    category: 'Wedding Highlights',
    eventLocation: 'Hindupur, Andhra Pradesh',
    eventYear: '2026',
    thumbnailUrl: 'https://lh3.googleusercontent.com/d/14Oc3e5cNWXMOGIxPXk4V-OlN620eBqWs',
    videoUrl: 'https://drive.google.com/file/d/14Oc3e5cNWXMOGIxPXk4V-OlN620eBqWs/view?usp=drive_link',
    videoSourceType: 'google_drive',
    externalDestUrl: 'https://youtube.com/@bharathkumarglp2003?si=ai6BueJG5fmOkrGX',
    description: 'Sacred Vedic muhurtham rituals, mangalashtak dialogue synchronization, and authentic gold silk color grading in DaVinci Resolve Studio.',
    softwareUsed: ['DaVinci Resolve Studio', 'Premiere Pro', 'FabFilter Pro'],
    isFeatured: true,
    isPublished: true,
    sortOrder: 1,
  ...
  {
    id: 'work-reception',
    title: 'Grand Wedding Reception & Gala Night Highlights',
    category: 'Wedding Highlights',
    eventLocation: 'Bengaluru, Karnataka',
    eventYear: '2026',
    thumbnailUrl: 'https://lh3.googleusercontent.com/d/1X-bWfeq-8smOgdl9jBgrRwx3RNimChCP',
    videoUrl: 'https://drive.google.com/file/d/1X-bWfeq-8smOgdl9jBgrRwx3RNimChCP/view?usp=drive_link',
    videoSourceType: 'google_drive',
    externalDestUrl: 'https://youtube.com/@bharathkumarglp2003?si=ai6BueJG5fmOkrGX',
    description: 'High-energy reception celebrations, stage entry pacing, dynamic lighting restoration, and cinematic multi-cam edit.',
  ...
  {
    id: 'work-prewedding',
    title: 'Enchanted Mist Romance | Pre-Wedding Narrative',
    category: 'Pre-Wedding Video Editing',
    eventLocation: 'Ooty Hills, Nilgiris',
    eventYear: '2026',
    thumbnailUrl: 'https://lh3.googleusercontent.com/d/1rqVfAXvqzroASucfdilB3-sRVGk9811Y',
    videoUrl: 'https://drive.google.com/file/d/1rqVfAXvqzroASucfdilB3-sRVGk9811Y/view?usp=share_link',
    videoSourceType: 'google_drive',
    externalDestUrl: 'https://youtube.com/@bharathkumarglp2003?si=ai6BueJG5fmOkrGX',
    description: 'Moody, slow-paced cinematic pre-wedding narrative in the pine forests of Ooty with custom color grading and warm acoustic melody.',
    softwareUsed: ['DaVinci Resolve Studio', 'After Effects', 'FabFilter Pro'],
    isFeatured: true,
    isPublished: true,
    sortOrder: 3,
    createdAt: '2026-08-10T12:00:00Z'
  ...
  {
    id: 'work-haldi',
    title: 'Yellow Splash Festivity | Haldi & Sangeeth Blast',
    category: 'Haldi & Sangeeth Ceremonies',
    eventLocation: 'Hindupur, Andhra Pradesh',
    eventYear: '2026',
    thumbnailUrl: 'https://lh3.googleusercontent.com/d/1dHZDL0B23QtW6yo6HK_MfcDTMHk4J6Dn',
    videoUrl: 'https://drive.google.com/file/d/1dHZDL0B23QtW6yo6HK_MfcDTMHk4J6Dn/view?usp=share_link',
    videoSourceType: 'google_drive',
    externalDestUrl: 'https://youtube.com/@bharathkumarglp2003?si=ai6BueJG5fmOkrGX',
    description: 'Ultra high-energy 120fps slow-motion water splash editing synced to electrifying folk beats and dance rhythms.',
    softwareUsed: ['Premiere Pro', 'DaVinci Resolve Color Studio'],
    isFeatured: true,
    isPublished: true,
    sortOrder: 4,
    createdAt: '2026-08-10T12:00:00Z'
  ...
  {
    id: 'work-maternity',
    title: 'Miracle of Motherhood | Maternity Visual Story',
    category: 'Maternity Shoot Videos',
    eventLocation: 'Nandi Hills Sunrise',
    eventYear: '2025',
    thumbnailUrl: 'https://lh3.googleusercontent.com/d/1lmZ0mHo4lRI-Ie3452i-wrkM1uFC0jji',
    videoUrl: 'https://drive.google.com/file/d/1lmZ0mHo4lRI-Ie3452i-wrkM1uFC0jji/view?usp=share_link',
    videoSourceType: 'google_drive',
    externalDestUrl: 'https://youtube.com/@bharathkumarglp2003?si=ai6BueJG5fmOkrGX',
    description: 'Golden hour pastel aesthetic maternity visual keepsake celebrating the beauty of new parenthood.',
    softwareUsed: ['DaVinci Resolve Studio', 'iZotope RX 10'],
    isFeatured: false,
    isPublished: true,
    sortOrder: 5,
    createdAt: '2026-08-10T12:00:00Z'
  ...
  {
    id: 'work-spot-editing',
    title: 'On-Venue Spot Editing & Reception Projection Showcase',
    category: 'Spot Editing Available',
    eventLocation: 'Anantapur, Andhra Pradesh',
    eventYear: '2026',
    thumbnailUrl: 'https://lh3.googleusercontent.com/d/1HQo2mJ2eszSMeSexO5wN2GxVMCTtJy2q',
    videoUrl: 'https://drive.google.com/file/d/1HQo2mJ2eszSMeSexO5wN2GxVMCTtJy2q/view?usp=share_link',
    videoSourceType: 'google_drive',
    externalDestUrl: 'https://youtube.com/@bharathkumarglp2003?si=ai6BueJG5fmOkrGX',
    description: 'Same-day on-venue live edit ingested in the morning and projected on large reception LED screens with instant teaser delivery.',
